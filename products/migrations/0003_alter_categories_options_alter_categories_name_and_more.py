    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slyg', models.SlugField(blank=True, max_length=200, null=True, unique=True, verbose_name='url')),
                ...
                ('descount', models.DecimalField(decimal_places=2, default=0.0, max_digits=7, verbose_name='Скидка в процентах')),
